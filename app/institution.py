...
_DOMAIN_MAP: dict[str, dict] = {
    ...
    "buffalo.edu":       {"institution": "University at Buffalo, SUNY",              "country": "US", "state": "NY"},
    "stonybrook.edu":    {"institution": "Stony Brook University, SUNY",             "country": "US", "state": "NY"},
    "binghamton.edu":    {"institution": "Binghamton University, SUNY",              "country": "US", "state": "NY"},
